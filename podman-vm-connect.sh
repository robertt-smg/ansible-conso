...
function podman_connect() {
    ...
    rm -rf /root/.ssh/config /root/.ssh/id_* && cp -rf /mnt/$HOME/.ssh/config /root/.ssh/config && cp -f /mnt/$HOME/.ssh/id_* /root/.ssh/
    cd /mnt/$PW
...
EOF
    ...
    ## 19... # FTI APP02 forwaring in ssh_config
     ...
     #   -R 192.168.11.1:3306:127.0.0.1:3306 \
     #   -R 192.168.11.1:9123:127.0.0.1:9123 \
